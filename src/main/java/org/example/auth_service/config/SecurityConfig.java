...
import org.example.auth_service.config.security.CustomAuthorizationRequestResolver;
import org.example.auth_service.config.security.service.CustomOAuth2UserService;
...
public class SecurityConfig {
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(originList); // Set allowed origins
